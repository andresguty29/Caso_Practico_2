...
namespace CasoPractico1.AccesoADatos.Citas.ListarServiciosCitas
{
    public class ListarServiciosCitasAD : IListarServiciosCitasAD
    {
        public List<ServiciosDTO> Obtener()
        {
            using (var contexto = new Contexto())
            {
                List<ServiciosDTO> laListaARetornar = (from servicios in contexto.Servicios
